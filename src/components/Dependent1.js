                                ...
                                <div className="shadow overflow-hidden sm:rounded-md">
                                    <div className="px-2 py-8 bg-white sm:p-6">
                                        ...
                                        <div className="col-span-6 sm:col-span-3">
                                            ...
                                            <div className="col-span-6 sm:col-span-3">
                                                <label htmlFor="last-name" className="block text-sm font-medium text-gray-700"> Name of School,College,University
                                                    </label>
                                                <input type="text" name="name" placeholder="Enter Your full Name" id="name" autoComplete="name" className="mt-1 focus:ring-indigo-500 text-gray-300  focus:border-indigo-500 block w-full shadow-sm sm:text-sm border border-gray-300 py-2 rounded-md" />
                                            </div>
                                            <div className="col-span-6 sm:col-span-3">
                                                <label htmlFor="last-name" className="block text-sm font-medium text-gray-700"> Grade
                                                    </label>
                                                <input type="text" name="name" placeholder="Enter Your full Name" id="name" autoComplete="name" className="mt-1 focus:ring-indigo-500 text-gray-300  focus:border-indigo-500 block w-full shadow-sm sm:text-sm border border-gray-300 py-2 rounded-md" />
                                            </div>
                                            <div className="col-span-6 sm:col-span-3">
                                            ...
                                            <div className="col-span-6 sm:col-span-3">
                                                <label htmlFor="last-name" className="block text-sm font-medium text-gray-700"> other Info
                                                    </label>
                                                <input type="text" name="name" placeholder="Enter Your full Name" id="name" autoComplete="name" className="mt-1 focus:ring-indigo-500 text-gray-300  focus:border-indigo-500 block w-full shadow-sm sm:text-sm border border-gray-300 py-2 rounded-md" />
                                            </div>
                                            <div className="col-span-6 sm:col-span-3">
